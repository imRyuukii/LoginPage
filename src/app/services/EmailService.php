...
class EmailService
{
    ...
    private function sendEmail($to, $subject, $htmlBody, $textBody = null)
    {
        ...
        try {
            ...
            // Log email attempt
            error_log(
                "Email verification sent to: $to, Result: " .
...
<head>
    ...
    <style>
        ...
        .code { background: #2e3944; border: 1px solid #4a5866; border-radius: 4px; padding: 8px 12px; font-family: monospace; margin: 10px 0; }
